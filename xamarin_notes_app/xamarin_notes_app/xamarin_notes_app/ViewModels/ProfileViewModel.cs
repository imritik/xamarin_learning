       ...
       public async void getProfileData()
        {
            ...
            if (profileData == null)
            {
                profileData = new ProfileModel("John Doe",2, "https://images.unsplash.com/photo-1626631048881-bcf878e6d575?ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxMnx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60");
